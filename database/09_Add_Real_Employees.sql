...
-- =============================================
-- ADD REAL EMPLOYEES WITH DIFFERENT DESIGNATIONS
-- This script adds 15 real employees for comprehensive testing
-- =============================================

PRINT '=============================================';
PRINT 'ADDING REAL EMPLOYEES FOR TESTING';
PRINT '=============================================';
...
PRINT 'Verifying inserted employee data:';
SELECT 
    e.EmployeeId,
    e.Name,
    e.Designation,
...
WHERE e.EmployeeId > (SELECT MAX(EmployeeId) - 15 FROM Employees)
...
PRINT '=============================================';
PRINT 'REAL EMPLOYEES ADDED SUCCESSFULLY!';
